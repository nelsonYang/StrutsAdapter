 ...
 */
@StrutsTag(name = "logic not equal", tldBodyContent = "equal", tldTagClass = " com.struts.adapter.tag.LogicNotEqualTag", description = "iterator a collection")
public class LogicNotEqualTag extends ComponentTagSupport {
    ...
    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res) {
       return new LogicNotEqual(stack,req,res);
    }
